  ...
  return (
    <div className="relative">
      {showMentions && filteredMembers.length > 0 && (
        <div className="absolute bottom-full mb-1 left-0 bg-white border border-gray-200 rounded-lg shadow-lg w-64 max-h-40 overflow-auto z-50">
      ...
      <div className="flex gap-2">
        <div className="flex-1 relative">
          <div
            ...
            onPaste={handlePaste}
            spellCheck={false}
            className="w-full bg-white rounded-input border-input transition-all duration-200 outline-none text-gray-700 shadow-input border-input-effect px-3 py-1.5 text-sm overflow-auto"
