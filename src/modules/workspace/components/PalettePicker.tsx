  ...
  return (
    <>
      <div className="flex flex-wrap gap-3">
        ...
        {/* Custom color button */}
        {customLocked ? (
          <div className="group flex flex-col items-center gap-1.5 opacity-50">
            <div className="w-8 h-8 rounded-full border-2 border-dashed border-subtle flex items-center justify-center">
