...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  issue: "bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-300",
      ...
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-6 mb-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <span className={`px-2.5 py-0.5 rounded-full text-xs font-medium ${CATEGORY_COLORS[ticket.category] || CATEGORY_COLORS.issue}`}>
              {t(`enum.category.${ticket.category}`)}
            </span>
          </div>
        </div>
