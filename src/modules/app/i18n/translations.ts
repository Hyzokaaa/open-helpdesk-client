const translations = {
  ...
  "contacts.invite": { en: "Invite Contact", es: "Invitar Contacto" },
  ...
  "enum.role.user": { en: "User", es: "Usuario" },
  ...
  "mailbox.postProcess": { en: "After processing", es: "Después de procesar" },
  "mailbox.postProcessDesc": { en: "What to do with emails after they are converted to tickets", es: "Qué hacer con los emails después de convertirlos en tickets" },
  "mailbox.postProcess.none": { en: "Do nothing", es: "No hacer nada" },
  "mailbox.postProcess.mark-read": { en: "Mark as read", es: "Marcar como leído" },
  "mailbox.postProcess.move": { en: "Move to folder", es: "Mover a carpeta" },
  "mailbox.postProcessFolder": { en: "Destination folder", es: "Carpeta de destino" },
  "mailbox.postProcessFolderDesc": { en: "The folder will be created automatically if it doesn't exist. If it can't be created, you'll need to create it manually in your email provider.", es: "La carpeta se creará automáticamente si no existe. Si no se puede crear, deberá crearla manualmente en su proveedor de email." },
  ...
  "filters.none": { en: "None", es: "Ninguno" },
  "filters.clearAll": { en: "Clear all", es: "Limpiar todo" },
  "filters.hiding": { en: "Hiding", es: "Oculto" },
  "filters.search": { en: "Search...", es: "Buscar..." },
  "filters.selectAll": { en: "Select all", es: "Seleccionar todo" },
  "filters.deselectAll": { en: "Deselect all", es: "Deseleccionar todo" },
  "filters.hidden": { en: "hidden", es: "ocultos" },
  "filters.other": { en: "Other", es: "Otros" },
  ...
  "settings.uploadAvatar": { en: "Upload photo", es: "Subir foto" },
  "settings.changeAvatar": { en: "Change photo", es: "Cambiar foto" },
  "settings.removeAvatar": { en: "Remove photo", es: "Eliminar foto" },
  ...
  "notifications.system": { en: "System", es: "Sistema" },
  "notifications.upgradeAvailable": { en: "Upgrade available", es: "Actualización disponible" },
  ...
  "legal.privacy.collect.title": { en: "Information We Collect", es: "Información que Recopilamos" },
  "legal.privacy.collect.desc": { en: "When you create an account, we collect your name, email address, and password (stored hashed). When you use the platform, we collect ticket data, comments, attachments, and usage metadata necessary to provide the service.", es: "Cuando crea una cuenta, recopilamos su nombre, dirección de email y contraseña (almacenada hasheada). Cuando usa la plataforma, recopilamos datos de tickets, comentarios, adjuntos y metadatos de uso necesarios para proveer el servicio." },
  "legal.privacy.use.title": { en: "How We Use Your Data", es: "Cómo Usamos sus Datos" },
  "legal.privacy.use.desc": { en: "Your data is used solely to provide the helpdesk service: account management, ticket processing, email notifications, and reporting. No data is sold or shared with third parties for marketing purposes.", es: "Sus datos se usan únicamente para proveer el servicio de helpdesk: gestión de cuentas, procesamiento de tickets, notificaciones por email y reportes. No se venden ni comparten datos con terceros para fines de marketing." },
  "legal.privacy.storage.title": { en: "Data Storage & Security", es: "Almacenamiento y Seguridad" },
  "legal.privacy.storage.desc": { en: "Data is stored in a PostgreSQL database with encryption in transit (TLS). Files are stored on the local filesystem. Industry-standard security practices are applied including role-based access control and password hashing.", es: "Los datos se almacenan en una base de datos PostgreSQL con encriptación en tránsito (TLS). Los archivos se almacenan en el sistema de archivos local. Se aplican prácticas de seguridad estándar de la industria incluyendo control de acceso basado en roles y hashing de contraseñas." },
  "legal.privacy.access.title": { en: "Data Access by Role", es: "Acceso a Datos por Rol" },
  "legal.privacy.access.desc": { en: "System Administrators have full access to all workspaces, users, tickets, and system configuration. Workspace Admins have full access within their workspace including members, tickets, and settings. Supervisors can manage tickets, members, and view reports within their workspace. Agents can view and manage tickets assigned to them or available for pickup. Users can only view and comment on their own tickets.", es: "Los Administradores del Sistema tienen acceso completo a todos los workspaces, usuarios, tickets y configuración del sistema. Los Admins de Workspace tienen acceso completo dentro de su workspace incluyendo miembros, tickets y configuración. Los Supervisores pueden gestionar tickets, miembros y ver reportes dentro de su workspace. Los Agentes pueden ver y gestionar tickets asignados a ellos o disponibles para tomar. Los Usuarios solo pueden ver y comentar en sus propios tickets." },
  "legal.privacy.thirdParty.title": { en: "Third-Party Services", es: "Servicios de Terceros" },
  "legal.privacy.thirdParty.desc": { en: "This software does not send your data to third-party services by default. All data is processed locally on this instance. If the operator has configured external email providers (SMTP), your email address may be shared with that provider for notification delivery. If OAuth login is enabled, your authentication data is exchanged with the configured identity provider.", es: "Este software no envía sus datos a servicios de terceros por defecto. Todos los datos se procesan localmente en esta instancia. Si el operador ha configurado proveedores de email externos (SMTP), su dirección de email puede compartirse con ese proveedor para la entrega de notificaciones. Si el inicio de sesión OAuth está habilitado, sus datos de autenticación se intercambian con el proveedor de identidad configurado." },
  "legal.privacy.rights.title": { en: "Your Rights", es: "Sus Derechos" },
  "legal.privacy.rights.desc": { en: "You have the right to access, correct, or delete your personal data at any time. Contact your system administrator for data export or account deletion requests.", es: "Tiene derecho a acceder, corregir o eliminar sus datos personales en cualquier momento. Contacte a su administrador del sistema para solicitudes de exportación de datos o eliminación de cuenta." },
  "legal.privacy.cookies.title": { en: "Cookies & Local Storage", es: "Cookies y Almacenamiento Local" },
  "legal.privacy.cookies.desc": { en: "This application uses browser local storage for authentication tokens and language preferences. No tracking cookies, third-party analytics, or advertising cookies are used.", es: "Esta aplicación usa almacenamiento local del navegador para tokens de autenticación y preferencias de idioma. No se usan cookies de seguimiento, analíticas de terceros ni cookies publicitarias." },
  "legal.privacy.contact.title": { en: "Contact", es: "Contacto" },
  "legal.privacy.contact.desc": { en: "For questions about this privacy policy or your data, contact the system administrator of this instance.", es: "Para preguntas sobre esta política de privacidad o sus datos, contacte al administrador del sistema de esta instancia." },

  "legal.terms.title": { en: "Terms of Service", es: "Términos de Servicio" },
  "legal.terms.intro": { en: "These terms govern your use of this Open Helpdesk instance. By using the platform, you agree to these terms.", es: "Estos términos rigen el uso de esta instancia de Open Helpdesk. Al usar la plataforma, acepta estos términos." },
  "legal.terms.service.title": { en: "The Service", es: "El Servicio" },
  "legal.terms.service.desc": { en: "Open Helpdesk is a helpdesk and ticket management platform. The operator of this instance is responsible for its availability and maintenance.", es: "Open Helpdesk es una plataforma de helpdesk y gestión de tickets. El operador de esta instancia es responsable de su disponibilidad y mantenimiento." },
  "legal.terms.accounts.title": { en: "Accounts", es: "Cuentas" },
  "legal.terms.accounts.desc": { en: "You are responsible for maintaining the security of your account and password. You are responsible for all activity that occurs under your account.", es: "Es responsable de mantener la seguridad de su cuenta y contraseña. Es responsable de toda actividad que ocurra bajo su cuenta." },
  "legal.terms.content.title": { en: "Your Content", es: "Su Contenido" },
  "legal.terms.content.desc": { en: "You retain all rights to the data you upload. The platform stores and processes your content solely to provide the helpdesk service.", es: "Retiene todos los derechos sobre los datos que sube. La plataforma almacena y procesa su contenido únicamente para proveer el servicio de helpdesk." },
  "legal.terms.acceptable.title": { en: "Acceptable Use", es: "Uso Aceptable" },
  "legal.terms.acceptable.desc": { en: "You agree not to use the platform for unlawful purposes, to abuse or harass others, to transmit malware, or to attempt to gain unauthorized access to other systems.", es: "Acepta no usar la plataforma para fines ilegales, abusar o acosar a otros, transmitir malware, o intentar obtener acceso no autorizado a otros sistemas." },
  "legal.terms.liability.title": { en: "Limitation of Liability", es: "Limitación de Responsabilidad" },
  "legal.terms.liability.desc": { en: "The software is provided \"as is\" without warranties of any kind. To the maximum extent permitted by law, the developers and operators shall not be liable for any indirect, incidental, or consequential damages.", es: "El software se proporciona \"tal cual\" sin garantías de ningún tipo. En la máxima medida permitida por la ley, los desarrolladores y operadores no serán responsables por daños indirectos, incidentales o consecuentes." },
  "legal.terms.changes.title": { en: "Changes to Terms", es: "Cambios a los Términos" },
  "legal.terms.changes.desc": { en: "These terms may be updated from time to time. Continued use of the platform after changes constitutes acceptance of the new terms.", es: "Estos términos pueden actualizarse periódicamente. El uso continuado de la plataforma después de los cambios constituye la aceptación de los nuevos términos." },
  "legal.terms.contact.title": { en: "Contact", es: "Contacto" },
  "legal.terms.contact.desc": { en: "For questions about these terms, contact the system administrator of this instance.", es: "Para preguntas sobre estos términos, contacte al administrador del sistema de esta instancia." },
  ...
  "branding.icon": { en: "Icon", es: "Icono" },
  "branding.iconHint": { en: "Square image used in the sidebar. Recommended: 128×128px or larger.", es: "Imagen cuadrada usada en la barra lateral. Recomendado: 128×128px o más." },
  "branding.uploadIcon": { en: "Upload icon", es: "Subir icono" },
  "branding.changeIcon": { en: "Change icon", es: "Cambiar icono" },
  "branding.iconTooLarge": { en: "Icon must be 512KB or less", es: "El icono debe ser de 512KB o menos" },
  "branding.remove": { en: "Remove", es: "Eliminar" },
  ...
  "admin.versionLatestComponent": { en: "Latest Component", es: "Último Componente" },
  ...
  "admin.upgradeNotifications": { en: "Upgrade Notifications", es: "Notificaciones de Actualización" },
  "admin.upgradeEmail": { en: "Email", es: "Email" },
  "admin.upgradeInApp": { en: "In-app notification", es: "Notificación en la app" },
  ...
  "auditLog.action.workspace-custom-domain-set": { en: "Custom Domain Set", es: "Dominio Personalizado Configurado" },
  "auditLog.action.workspace-custom-domain-removed": { en: "Custom Domain Removed", es: "Dominio Personalizado Eliminado" },
  "auditLog.action.workspace-custom-domain-verified": { en: "Custom Domain Verified", es: "Dominio Personalizado Verificado" },
  "auditLog.action.workspace-branding-updated": { en: "Branding Updated", es: "Marca Actualizada" },
  "auditLog.action.system-branding-updated": { en: "System Branding Updated", es: "Marca del Sistema Actualizada" },
  "auditLog.action.department-created": { en: "Department Created", es: "Departamento Creado" },
  "auditLog.action.department-updated": { en: "Department Updated", es: "Departamento Actualizado" },
  "auditLog.action.department-deleted": { en: "Department Deleted", es: "Departamento Eliminado" },
  "auditLog.action.department-member-added": { en: "Department Member Added", es: "Miembro de Departamento Agregado" },
  "auditLog.action.department-member-removed": { en: "Department Member Removed", es: "Miembro de Departamento Eliminado" },
  "auditLog.action.organization-created": { en: "Organization Created", es: "Organización Creada" },
  "auditLog.action.organization-updated": { en: "Organization Updated", es: "Organización Actualizada" },
  "auditLog.action.organization-deleted": { en: "Organization Deleted", es: "Organización Eliminada" },
  ...
  "workspaceSettings.users": { en: "Users", es: "Usuarios" },
